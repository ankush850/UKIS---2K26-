"""
Residual-in-Residual Dense Block Network (RRDBNet) architecture.
Official generator architecture for ESRGAN and Real-ESRGAN (Wang et al.).
Loaded by weights/RealESRGAN_x4plus.pth (16.7M parameters).
"""
import torch
...
class RRDB(nn.Module):
    """Residual in Residual Dense Block containing 3 nested RDBs."""
    def __init__(self, num_feat: int = 64, num_grow_ch: int = 32):
        super().__init__()
...
class RRDBNet(nn.Module):
    """
    RRDBNet Generator for Real-ESRGAN x4plus.
    23 RRDB blocks, 64 features, 32 growth channels (~16.7M parameters).
    """
    def __init__(
        self,
        in_channels: int = 3,
